# Python AI Engineering Extension Pack

[![Visual Studio Marketplace](https://img.shields.io/visual-studio-marketplace/v/mfmezger.python-ai-engineering?style=flat-square&label=VS%20Marketplace)](https://marketplace.visualstudio.com/items?itemName=mfmezger.python-ai-engineering)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg?style=flat-square)](LICENSE)

A curated collection of VS Code extensions for AI Engineering and Python development, including tools for code quality, Git, Markdown, and more.
...
- [JSON2CSV](https://marketplace.visualstudio.com/items?itemName=khaeransori.json2csv) - JSON to CSV conversion
- [Excel Viewer](https://marketplace.visualstudio.com/items?itemName=grapecity.gc-excelviewer) - View Excel files
...
- [JSON Lens](https://marketplace.visualstudio.com/items?itemName=mohitkumartoshniwal.jsonlens) - JSON visualization
- [Format JSON](https://marketplace.visualstudio.com/items?itemName=clemenspeters.format-json) - JSON formatting
- [JSON Parse & Stringify](https://marketplace.visualstudio.com/items?itemName=nextfaze.json-parse-stringify) - JSON utilities
- [JSON](https://marketplace.visualstudio.com/items?itemName=zainchen.json) - JSON tools
...
- [Indent Rainbow](https://marketplace.visualstudio.com/items?itemName=oderwat.indent-rainbow) - Indentation colors
...
- [Make Task Provider](https://marketplace.visualstudio.com/items?itemName=carlos-algms.make-task-provider) - Run Makefile tasks
- [Dependi](https://marketplace.visualstudio.com/items?itemName=fill-labs.dependi) - Dependency management
...
3. Search for "Python AI Engineering Extension Pack"
4. Click Install

Or install via CLI:

```bash
code --install-extension mfmezger.python-ai-engineering
```

## 📄 License

MIT © [mfmezger](https://github.com/mfmezger)
